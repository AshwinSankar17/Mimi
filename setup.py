...
# read version
with open(os.path.join(here, "mimi", "__init__.py"), encoding="utf-8") as f:
    for line in f:
...
setuptools.setup(
    name="mimi",
    version=version,
    description="Toolkit for using and training Mimi, a high-quality low frame-rate neural audio codec model.",
